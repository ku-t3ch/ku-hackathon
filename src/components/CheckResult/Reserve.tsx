        ...
        <div className="flex flex-col gap-5">
            <div className="flex flex-col gap-2">
                <div className="flex flex-col">
                    {data?.team_id && <div className="text-xl">ทีม : <span className="font-bold">{data?.team_id}</span></div>}
                    <div className="text-xl">ชื่อ : <span className="font-bold">{data?.name}</span></div>
                </div>
                <div className="text-xl">
                    ยินดีด้วย คุณผ่านการคัดเลือกเป็นตัวสำลอง
                </div>
