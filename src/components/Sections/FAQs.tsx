...
const faqs: FAQS[] = [
  ...
  },
  {
    ...
    children:
      'ได้ แต่แนะนำให้มาจับกลุ่มกันในรูปแบบ OnSite เพื่อที่น้อง ๆ จะสามารถเลือกทีมได้ หากไม่สามารถมาได้ น้อง ๆ จะถูกจับกลุ่มโดยรูปแบบสุ่มอัตโนมัติ',
  },
];
...
const FAQs: NextPage<Props> = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mt-[2.5rem] md:mt-[5rem] w-full grid grid-cols-1 md:grid-cols-2 gap-[1rem]">
        {width >= 768 ? (
          <>
