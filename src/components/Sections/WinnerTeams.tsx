...
const teams = [
    ...
    },
    {
        ...
        detail: "/summary/2023/paipibadradapmorram"
    },
    {
        rankId: 2,
                    ...
                    >
                        {getTeams(isMobile).map((item, index) => (
                            ...
                            >
                                ...
                                <div
                                    onClick={() => push(item.detail)}
                                    
                                    key={index}
                                    className={clsx(
                                        'relative w-full bg-gray-800 hover:bg-gray-700 cursor-pointer border border-gray-700 px-[1.5rem] shadow',
